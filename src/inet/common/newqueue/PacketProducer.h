...
class INET_API PacketProducer : public cSimpleModule, public IPacketProducer, public IPacketQueueElement, public IPacketConsumer::IListener
{
  protected:
  ...
  protected:
    ...
    virtual void schedulerProductionTimer();
