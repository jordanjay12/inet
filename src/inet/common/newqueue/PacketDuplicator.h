...
class INET_API PacketDuplicator : public cSimpleModule, public PacketConsumerBase, public IPacketProducer, public IPacketQueueElement, public IPacketConsumer::IListener
{
  protected:
