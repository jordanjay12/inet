...
class INET_API PacketFilterBase : public cSimpleModule, public IPacketFilter, public IPacketQueueElement, public IPacketConsumer::IListener, public IPacketProvider::IListener
{
  protected:
  ...
  protected:
    ...
    virtual bool filterPacket(Packet *packet) = 0;
