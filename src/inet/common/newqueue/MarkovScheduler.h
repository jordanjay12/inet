...
class INET_API MarkovScheduler : public cSimpleModule, public PacketConsumerBase, public IPacketQueueElement, public IPacketConsumer::IListener
{
  protected:
  ...
  protected:
    ...
    virtual int schedulePacket() const;
  ...
  public:
    ...
    virtual bool canPushAnyPacket(cGate *gate) override;
