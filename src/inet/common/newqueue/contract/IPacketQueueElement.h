...
#ifndef __INET_IPACKETQUEUEELEMENT_H
#define __INET_IPACKETQUEUEELEMENT_H
...
/**
 * This class defines the interface for packet queue elements.
 */
class INET_API IPacketQueueElement
{
  public:
    virtual ~IPacketQueueElement() {}
...
#endif // ifndef __INET_IPACKETQUEUEELEMENT_H
