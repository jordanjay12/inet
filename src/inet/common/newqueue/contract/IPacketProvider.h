...
class INET_API IPacketProvider
{
  public:
    class INET_API IListener
    {
      public:
        /**
         * Notifies the listener about a change in state that allows to pop
         * some packet from the provider at the given gate. The gate is never
         * nulltr.
         */
        virtual void notifyCanPopPacket(cGate *gate) = 0;
    };
