...
class INET_API IPacketConsumer
{
  public:
    class INET_API IListener
    {
      public:
        /**
         * Notifies the listener about a change in state that allows to push
         * some packet into the consumer at the given gate. The gate is never
         * nullptr.
         */
        virtual void notifyCanPushPacket(cGate *gate) = 0;
    };
  ...
  public:
     ...
     */
    virtual bool canPushAnyPacket(cGate *gate = nullptr) = 0;
    ...
    /**
     * Adds a listener to the list of listeners that will be notified about
     * changes in the state of the consumer. The listener must not be already
     * added.
     */
    virtual void addListener(IListener *listener) = 0;

    /**
     * Removes a listener from the list of listeners that will be notified about
     * changes in the state of the consumer. The listener must be already added.
     */
